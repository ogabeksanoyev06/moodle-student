  ...
  <div id="home__container">
    <div class="main__header">
      <div class="navbar">
        <div class="navbar-container">
          <router-link to="/">
            <div class="left__side__navbar">
              <div class="logo">
                <img src="/icons/logo.png" />
              </div>
            </div>
          </router-link>
          <div class="right__side__navbar">
            <div class="language">
      ...
      <div class="header">
        <div class="header-container">
          ...
          <div class="header__right">
            <div class="header__main__img">
              <kinesis-container class="header-img1">
                <kinesis-element>
                  <img src="/icons/imgHeader1.svg" />
                </kinesis-element>
              </kinesis-container>
              <kinesis-container class="header-img2">
                <kinesis-element>
                  <img src="/icons/imgHeader2.svg" />
                </kinesis-element>
              </kinesis-container>
            </div>
          </div>
          <kinesis-container class="posetion-line">
            <kinesis-element>
              <img src="/icons/line.svg" />
            </kinesis-element>
          </kinesis-container>
          <kinesis-container class="posetion-sfera">
            <kinesis-element>
              <img src="/icons/sfera.svg" />
            </kinesis-element>
          </kinesis-container>
          <kinesis-container class="posetion-half-sfera">
            <kinesis-element>
              <img src="/icons/halfSfera.svg" />
            </kinesis-element>
          </kinesis-container>
        </div>
      </div>
    ...
    <div class="section-about">
      <div class="section-container">
        <div class="card" v-for="(iteam, i) in cards" :key="i">
          <div class="icon">
            <img :src="'/icons/' + iteam.icon" />
          </div>
          <div class="card-content">
            <div class="card-title">
              <div class="title">{{ iteam.title }}</div>
              <div class="subtitle">{{ iteam.subTitle }}</div>
              <div class="amount">{{ iteam.amout }} ta</div>
            </div>
          </div>
        </div>
      </div>
      <kinesis-container class="posetion-line2">
        <kinesis-element>
    ...
    <div class="footer">
      <div class="footer-container">
        <div class="titles">
          <div>
            <div class="footer-title">Biz bilan bog'laning</div>
            <div class="common-info responsive">
              <li>Tel:<a href="#">(998)917381025</a></li>
              <li>Fax:<a href="#">(998)917381025</a></li>
              <li>Email:<a href="#">(998)917381025</a></li>
              <li>Ishonch telfoni:<a href="#">(998)917381025</a></li>
            </div>
          </div>
          <div>
            <div class="footer-title">Toshkent moliya instituti</div>
            <div class="common-info responsive">
              <li>Rasmiy website:<a href="#">tfi.uz</a></li>
            </div>
          </div>
          <div>
            <div class="footer-title">Manzil</div>
            <div class="yandexMap responsive">
              <iframe
                src="https://yandex.com/map-widget/v1/?ll=69.282639%2C41.324365&mode=search&oid=1724782675&ol=biz&z=18.07"
                width="368"
                height="300"
                frameborder="1"
                allowfullscreen="true"
                style="position: relative; border-radius: 24px; border: none"
              ></iframe>
            </div>
          </div>
          <div>
            <div class="social-media responsive">
              <div class="footer-title">Ijtimoiy saxifalar</div>
              <div class="icons">
                <a href="#"
                  ><svg
                    width="20"
        ...
        <div class="bottom-footer-content">
          Copyright © 1999-2023. Сайтда жойлаштирилган барча маълумотлар
          Ўзбекистон ва халқаро қонунчилик муаллифлик хуқуқлари асосида
          химояланган. <br />
          Сайтдаги маълумотлардан сайт муаллифи рухсатисиз фойдаланиш
          таъқиқланади.
        </div>
      </div>
    </div>
  ...
  .section-about {
    ...
    .section-container {
      ...
      .card {
        ...
        border-radius: 24px;
        background: #fff;
        box-shadow: 0px 0px 30px 0px #a9b9dd;
        width: 403px;
        height: 331px;
        flex-shrink: 0;
        padding: 20px;
